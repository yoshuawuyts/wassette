...
macro_rules! __export_world_fetch_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[export_name = "fetch"] unsafe extern "C" fn export_fetch(arg0
        : * mut u8, arg1 : usize,) -> * mut u8 { $($path_to_types)*::
        _export_fetch_cabi::<$ty > (arg0, arg1) } #[export_name = "cabi_post_fetch"]
        unsafe extern "C" fn _post_return_fetch(arg0 : * mut u8,) { $($path_to_types)*::
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.30.0:fetch:encoded world"]
#[doc(hidden)]
...
j\x01s\x01s\x01@\x01\x03urls\0\0\x04\0\x05fetch\x01\x01\x04\x01\x18component:fet\
ch-rs/fetch\x04\0\x0b\x0b\x01\0\x05fetch\x03\0\0\0G\x09producers\x01\x0cprocesse\
