...
import (
	...
	monotonicclock "gomodule-server-go/gen/wasi/clocks/monotonic-clock"
	ioerror "gomodule-server-go/gen/wasi/io/error"
	"gomodule-server-go/gen/wasi/io/poll"
	"gomodule-server-go/gen/wasi/io/streams"
)
